...
/**
 * Provides the local service interface for CRUD. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author liferay
 * @see CRUDLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CRUDLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>crud.backend.service.impl.CRUDLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the crud local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CRUDLocalServiceUtil} if injection and service tracking are not available.
	 */
