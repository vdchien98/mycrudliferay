...
package crud.backend.service.persistence.impl.constants;
...
public class CRPersistenceConstants {

	public static final String BUNDLE_SYMBOLIC_NAME = "crud.backend.service";
